...
const lahmacun: MenuItem[] = [
  ...
  { id: 'lahmacun-teller', category: 'lahmacun', name: 'Lahmacun-Teller', priceEur: 13.0 },
];
...
const vegetarisch: MenuItem[] = [
  ...
  { id: 'veg-reisbox', category: 'vegetarisch', name: 'Reisbox mit Soße', priceEur: 6.0, tag: 'vegetarisch' },
...
const nuggets: MenuItem[] = [
  ...
  { id: 'nuggets-5er-box', category: 'nuggets', name: '5er Nuggets-Box', description: 'Pommes/Salat/Reis.', priceEur: 8.0 },
  { id: 'nuggets-teller-8', category: 'nuggets', name: 'Nuggets-Teller (8 St., 2 Beilagen)', priceEur: 13.0 },
  { id: 'nuggets-6', category: 'nuggets', name: 'Nuggets 6 Stück', priceEur: 5.5 },
  { id: 'nuggets-12', category: 'nuggets', name: 'Nuggets 12 Stück', priceEur: 9.0 },
];
...
const pizza: MenuItem[] = [
  ...
  { id: 'pizza-margherita', category: 'pizza', name: 'Margherita', priceEur: 8.0, markings: ['4', 'a', 'b', 'd'], promoPriceMap: PIZZA_MI },
  ...
  { id: 'pizza-funghi', category: 'pizza', name: 'Funghi', priceEur: 9.0, markings: ['4', 'a', 'b', 'd'], promoPriceMap: PIZZA_MI },
  { id: 'pizza-broccoli', category: 'pizza', name: 'Broccoli', priceEur: 9.0, promoPriceMap: PIZZA_MI },
  ...
  { id: 'pizza-sucuk', category: 'pizza', name: 'Sucuk', priceEur: 10.0, markings: ['4', 'a', 'b', 'd'], promoPriceMap: PIZZA_MI },
  ...
  { id: 'pizza-artischocken', category: 'pizza', name: 'Artischocken', priceEur: 9.0, promoPriceMap: PIZZA_MI },
  ...
  { id: 'pizza-thunfisch', category: 'pizza', name: 'Thunfisch', priceEur: 9.0, markings: ['c'], promoPriceMap: PIZZA_MI },
  { id: 'pizza-thunfisch-zwiebel', category: 'pizza', name: 'Thunfisch Zwiebel', priceEur: 9.5, markings: ['c'], promoPriceMap: PIZZA_MI },
  { id: 'pizza-gemischt', category: 'pizza', name: 'Gemischt', description: 'Salami, Schinken, Peperoni, Paprika.', priceEur: 11.0, promoPriceMap: PIZZA_MI },
  ...
  { id: 'pizza-meeresfruechte', category: 'pizza', name: 'Meeresfrüchte', priceEur: 9.0, markings: ['c'], promoPriceMap: PIZZA_MI },
  ...
  { id: 'pizza-vier-kaese', category: 'pizza', name: 'Vier Käse', description: 'Edamer, Mozzarella, Weichkäse, Gorgonzola.', priceEur: 11.0, markings: ['d'], promoPriceMap: PIZZA_MI },
];

/* ─────────── Pide (Di: 9 €) ─────────── */
const PIDE_DI = { 2: 9.0 } as const;
const pide: MenuItem[] = [
  { id: 'pide-weichkaese', category: 'pide', name: 'Pide Weichkäse', priceEur: 8.5, markings: ['1', '4', 'a', 'b', 'd'], promoPriceMap: PIDE_DI },
  ...
  { id: 'pide-kebap', category: 'pide', name: 'Pide Kebap', priceEur: 11.0, promoPriceMap: PIDE_DI },
  { id: 'pide-sucuk', category: 'pide', name: 'Pide Sucuk', priceEur: 11.0, promoPriceMap: PIDE_DI },
  { id: 'pide-spinat-kaese', category: 'pide', name: 'Pide Spinat & Weichkäse', priceEur: 9.0, markings: ['1', '4', 'a', 'b', 'd'], promoPriceMap: PIDE_DI },
  { id: 'pide-spinat-kaese-ei', category: 'pide', name: 'Pide Spinat, Weichkäse, Ei', priceEur: 10.0, markings: ['1', '4', 'a', 'b', 'd'], promoPriceMap: PIDE_DI },
  { id: 'pide-sucuk-ei', category: 'pide', name: 'Pide Sucuk + Ei', priceEur: 12.0, markings: ['3', '6', 'a', 'b', 'd'], promoPriceMap: PIDE_DI },
  { id: 'pide-vegetarisch', category: 'pide', name: 'Pide Vegetarisch', description: 'Spinat, Käse, Paprika, Pilz, Ei.', priceEur: 11.0, tag: 'vegetarisch', promoPriceMap: PIDE_DI },
];

/* ─────────── Seele (Sa: Spezial) ─────────── */
const seele: MenuItem[] = [
  { id: 'seele-weichkaese', category: 'seele', name: 'Seele Weichkäse', priceEur: 9.0, markings: ['1', '4', 'a', 'b', 'd'] },
  { id: 'seele-spinat-kaese', category: 'seele', name: 'Seele Spinat & Weichkäse', priceEur: 10.0, markings: ['1', '4', 'a', 'b', 'd'] },
  { id: 'seele-spinat-kaese-ei', category: 'seele', name: 'Seele Spinat, Weichkäse, Ei', priceEur: 10.0, markings: ['1', '4', 'a', 'b', 'd'] },
...
const burger_kebap: MenuItem[] = [
  { id: 'burger-standard', category: 'burger_kebap', name: 'Burger Kebap', priceEur: 4.0 },
  { id: 'burger-cheese', category: 'burger_kebap', name: 'Cheeseburger Kebap', priceEur: 5.0 },
  { id: 'burger-chili-cheese', category: 'burger_kebap', name: 'Chili-Cheeseburger Kebap', priceEur: 6.0, tag: 'scharf' },
  { id: 'burger-falafel', category: 'burger_kebap', name: 'Falafel-Burger', priceEur: 5.0, tag: 'vegetarisch' },
  { id: 'burger-falafel-cheese', category: 'burger_kebap', name: 'Falafel-Burger mit Cheese', priceEur: 6.0, tag: 'vegetarisch' },
  { id: 'burger-nuggets', category: 'burger_kebap', name: 'Chicken-Nuggets-Burger', priceEur: 5.0 },
  { id: 'burger-nuggets-cheese', category: 'burger_kebap', name: 'Chicken-Nuggets-Burger mit Cheese', priceEur: 6.0 },
  { id: 'chili-cheese-pommes-burger', category: 'burger_kebap', name: 'Chili Cheese (Pommes/Schmelzkäse/Jalapeños)', priceEur: 6.5, tag: 'scharf' },
];
